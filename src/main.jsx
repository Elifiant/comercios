...
let Componente = App; if (ruta.startsWith("/supervisor")) { Componente = Supervisor; } else if (ruta.startsWith("/admin")) { Componente = AdminClientes; } else if (ruta.startsWith("/web")) { Componente = WebComercial; } else if (ruta.startsWith("/pedidos")) { Componente = MonitorPedidos; }
