...
const codigo = [
  ...
  '                <button onClick={() => alert("Comanda lista para despachar.")} style={{ flex: 1, background: "#2563eb", color: "#fff", border: "none", padding: "10px", borderRadius: "8px", fontSize: "12px", fontWeight: "800", cursor: "pointer" }}>',
  '                  📦 Pasar a Depósito',
  '                </button>',
  '              </div>',
  '            </div>',
...
console.log('EXITO_MONITOR_ACTUALIZADO_100');
